...
var update_chart = function () {
      dataProvider.images.push(newest_json); // Put the newest location in the array
      map.write("mapdiv");   // re-write the map
      dataProvider.images = [];     // clear the locations array
}

AmCharts.ready(function() {
    map = new AmCharts.AmMap();
    map.pathToImages = "public/images/";			    
    ...
    var dataProvider = {
        ...
        images: [
      	{svgPath:targetSVG, zoomLevel:5, scale:0.5, title:"Vienna", latitude:48.2092, longitude:16.3728},
            ...
            {svgPath:targetSVG, zoomLevel:5, scale:0.5, title:"Jerusalem", latitude:31.7857, longitude:35.2007},
            ...
            {svgPath:targetSVG, zoomLevel:5, scale:0.5, title:"Poopie", latitude:38.8921, longitude:-77.0241},
